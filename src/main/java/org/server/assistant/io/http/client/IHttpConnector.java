...
public interface IHttpConnector<T> {
  ...
  default T post(String params, Map<String, Object> head) throws Exception {
    return post(params, EMPTY_BYTES, head);
  }
  ...
  default T post(Map<String, Object> params, byte[] bytes) throws Exception {
    return post(makeParams(params), bytes, EMPTY_HEAD);
  }
  ...
  static String makeParams(Map<String, Object> params) throws IOException {
  ...
  static String encodeValue(Object param) throws IOException {
    return encode(String.valueOf(param), "utf-8");
  }

  interface IResponseCodeHandler {
